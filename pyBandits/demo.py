...
nbRepPerRun = 10
horizon = 1000
num_processes = 4  # parallelization
...
if graphic == 'yes':
    ...
    plt.savefig('/home/mastane/Documents/telecom/profitablebandits/acml2018/fig_markers/scenar{}_horiz{}_rep{}_seed{}_markers.pdf'.format(scenario, horizon, nbRep, seed0), bbox_inches='tight')
    plt.show()
